...
<body>
					...
					<div>
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<form class="form-light mt-20" action="File_Upload"
									...
									<div class="form-group">
										<input type="text" class="form-control" name="attribute_1"
											placeholder="Enter File Name" required> <br> <input
											type="text" class="form-control" readonly="readonly"
											name="attribute_2" placeholder="Enter Owner Name"
											value="<%=oname%>" required> <br> <input
											type="text" class="form-control" name="attribute_3"
											placeholder="Enter  File Description" required> <br>
										<input type="text" class="form-control" name="attribute_4"
											readonly="readonly" placeholder="Enter Date"
											value="<%=currentdate%>" required> <br> <input
											type="text" class="form-control" name="attribute_5"
											readonly="readonly" placeholder="Enter Mobile No"
  ...
  <option value="Female">Female</option>  
									...
									<div align="left">
										<input type="text" class="form-control" name="role"
											readonly="readonly" placeholder="Enter Role"
											value="<%=role%>" required> <br> <input
											type="text" class="form-control" name="O_number"
											readonly="readonly" placeholder="Enter Owner Numbers"
											value="<%=O_id%>" required>
  ...
  <option value="Marketing">Marketing</option>
									...
									<br> <input type="submit" class="btn btn-two"> <input
										type="reset" class="btn btn-danger"><br /> <br />
								</form>
							</div>
						</div>
					</div>
