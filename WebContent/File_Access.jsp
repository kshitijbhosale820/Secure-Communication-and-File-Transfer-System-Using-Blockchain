...
<body>
	<div class="navbar navbar-inverse" style="background-color: black;">
		<div class="container" align="right">
			...
			String queryString01 = "select * FROM tbluser WHERE U_Email_ID='" + uemail + "'";
			PreparedStatement ptmt01 = connection01.prepareStatement(queryString01);
			String costdb = "";
			ResultSet resultSet01 = ptmt01.executeQuery();
			if (resultSet01.next()) {
				costdb = resultSet01.getString("Account_Balances");
			}
			%>
	...
	<section class="container">
		...
		<TABLE class="table table-bordered">
			...
			ResultSet resultset = statement.executeQuery("select * from filerequest  where username='" + emailid + "'");
