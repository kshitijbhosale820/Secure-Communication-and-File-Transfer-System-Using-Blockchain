	...
	<section class="container" style="width: 1290px;">
		...
		<TABLE class="table table-bordered">
			...
			<TR>
				...
				<TD><a
					href="O_History_Request?uemail=<%=resultset.getString(3)%>"><input
						type="submit" name="sendkey" value="Accept"
						class="btn btn-primary"></a></TD>
				<TD><a
					href="O_History_Reject?uemail=<%=resultset.getString(3)%>"><input
						type="button" name="sendkey" value="Reject"
						class="btn btn-primary"></a></TD>
