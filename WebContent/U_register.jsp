...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li><a href="Signin.jsp">Data User</a></li>
					<li><a href="owner_signin.jsp">Data Owner</a></li>
					<li><a href="admin_signin.jsp">Authority</a></li>
	...
	<section class="container">
		...
		<div class="row">
			<div class="col-md-4">
				<img src="./images/index.jpg" alt="" style="height: 85%"
						...
						<div class="modal-body">
							<div class="form-group" align="left">
								<input type="text" class="form-control" name="name"
									placeholder="Your Name" required pattern="[a-zA-Z\s]+"
									title="Enter Your Name(eg.abc)">
							</div>
							<div class="form-group" align="left">
								<input type="text" class="form-control"
									pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"
									id="inputEmail" placeholder="Email ID" name="email" required
									pattern=".*@gmail\.com"
							...
							<div align="left">
								<button type="submit" id="submit" class="btn btn-success">Sign
									Up</button>
							...
							<div align="right">
								Back to User Login Page: <a href="Signin.jsp"><button
										type="button" class="btn btn-link">Sign In</button></a>
							</div>
						</div>
					</div>
				</form>
			...
			<div class="container">
				<div class="col-md-6 panel">
					<div class="panel-body">
						<p class="text-right">Copyright &copy; 2015-16.</p>
					</div>
				</div>
