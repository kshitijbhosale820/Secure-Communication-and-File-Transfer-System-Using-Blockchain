...
<body>
	...
	<section class="container">
		<div class="heading">
			<!-- Heading -->
			<h2>Our File Share User Name</h2>
		</div>
		<div class="row">
			<div class="col-md-4">
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div style="margin-left: 20px; margin-right: 20px">
									<form action="ShareServlet" name="frm" method="post">
										<TABLE class="table table-bordered">
											...
											<tr>
												<input type="hidden" class="form-control" name="filename" value="<%=request.getParameter("rad1")%>" />
												<td>
											</tr>
											...
											<TR>
												...
												<TD><input type="checkbox" name="Checkbox"
													value="<%=resultset.getString(3)%>" /><b><%=resultset.getString(2)%></TD>
											...
											%>
											<tr>
												<td><input type="submit" name="ok" value="Share"
