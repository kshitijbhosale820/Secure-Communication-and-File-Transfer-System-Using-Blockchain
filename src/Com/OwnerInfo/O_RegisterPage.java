		...
		try {
			...
			ResultSet rs=user.O_chckemail(O_Email_ID);
				...
				else
				{
					...
					String queryString = "insert into tblowner(O_Name, O_Email_ID, O_Password, O_Gender,O_Mobile,O_Role,Birth_Date,O_Status,O_Number) values(?,?,?,?,?,?,?,?,?)";
					...
					ptmt.setString(8,O_Status);
					ptmt.setString(9,O_Number);
