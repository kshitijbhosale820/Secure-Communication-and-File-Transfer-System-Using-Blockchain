	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs=user.chckemail(U_Email_ID);
				...
				{
					String payment="1000";
					String U_Status="Pending";
					
					String queryString = "insert into tbluser(U_Name,U_Email_ID,U_Password,U_Gender,U_Role,U_Mobile,Account_Balances,Birth_Date,U_Status) values(?,?,?,?,?,?,?,?,?)";
